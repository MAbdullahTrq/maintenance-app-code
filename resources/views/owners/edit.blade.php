        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Edit Owner</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow">
        ...
        <form action="{{ route('owners.update', $owner) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="tel" name="phone" id="phone" value="{{ old('phone', $owner->phone) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="text" name="company" id="company" value="{{ old('company', $owner->company) }}" 
            ...
            <div class="mb-4">
                ...
                <textarea name="address" id="address" rows="3" 
                    class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('address') border-red-500 @enderror">{{ old('address', $owner->address) }}</textarea>
                @error('address')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="notes" id="notes" rows="4" 
                    ...
                    placeholder="Any additional notes or information about the owner...">{{ old('notes', $owner->notes) }}</textarea>
                @error('notes')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Update Owner</button>
            </div>
        </form>
    </div>
</div>
