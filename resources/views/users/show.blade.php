...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex flex-wrap gap-4 mt-6">
        @can('update', $user)
            ...
            @if($user->role->slug === 'property-manager')
                <a href="{{ route('admin.users.grant-subscription.create', $user) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
