...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-user-edit mr-2 text-blue-500"></i>Edit User: {{ $user->name }}
        </h1>
        <div>
            @if(isset($isAdminRoute) && $isAdminRoute)
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <div class="bg-gray-50 px-6 py-4 border-b">
            <h2 class="text-lg font-semibold text-gray-800">
                <i class="fas fa-user-edit mr-2 text-blue-500"></i>Edit User Information
            </h2>
        </div>
        <div class="p-6">
            @if($errors->any())
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-lock mr-2 text-gray-500"></i>Password (leave blank to keep current)
                        </label>
