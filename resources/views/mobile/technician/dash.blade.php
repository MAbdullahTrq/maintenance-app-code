...
@section('content')
<div style="background:#ffff99;padding:4px 0;text-align:center;font-weight:bold;">Dash – Technician</div>
<div style="font-size:12px;text-align:center;margin-bottom:8px;">maintainxtra.com/t/dash</div>
...
<div style="display:flex;justify-content:space-between;margin-bottom:12px;">
    <div style="flex:1;text-align:center;">
        Assigned<br><b>{{ $counts['assigned'] }}</b>
    </div>
    <div style="flex:1;text-align:center;">
        Accepted<br><b>{{ $counts['accepted'] }}</b>
    </div>
    <div style="flex:1;text-align:center;">
        Completed<br><b>{{ $counts['completed'] }}</b>
    </div>
</div>
<h2 style="text-align:center;font-size:1.2em;margin:16px 0 8px;">Assigned</h2>
